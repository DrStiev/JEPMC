...
function nn_ode(
    ...
    U = Lux.Chain(Lux.Dense(5, 64, activation_function), Lux.Dense(64, 1))
    ...
    prob_nn = ODEProblem(nn_dynamics!, data[:, 1], (tspan[1], tspan[end]), p)
...
# plt = plot_loss(losses, ["ADAM", "BFGS"], maxiters)
# include("Utils.jl")
